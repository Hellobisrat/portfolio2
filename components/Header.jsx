  ...
  return (
    ...
    items-center justify-center gap-4 '>
      ...
      className='flex items-end text-xl md:text-2xl mb-3 font-Ovo'>
          Hi I'm Bisrat Mengesha <Image src={assets.hand_icon} alt=''
        ...
        transition={{duration:0.8, delay:0.5}}
         className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
          Frontend web developer based in Dallas.
        </motion.h1>
        <motion.p
        initial={{ opacity:0}}
        ...
        transition={{duration:0.6, delay:0.7}}
         className='font-Ovo max-w-2xl mx-auto'>
          I am a frontend developer from Dallas, USA with 2 years of experience
          in some companies .
        </motion.p>
