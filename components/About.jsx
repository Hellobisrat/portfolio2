      ...
      gap-20 my-20'>
          ...
          className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'> 
              I am experienced Frontend Developer with over years 
                of professional expertise in the field.
                Throughout my carrer, I have had the privilege of
                collaborating with Pretigious organizations,
            ...
            transition={{duration:0.8,delay:1}} 
             className='grid grid-cols-1 sm:grid-cols-3
              ...
              {infoList.map(({icon,iconDark,title,description},index)=>(
                ...
                key={index}><Image src={ isDarkMode? iconDark :icon} alt={title} className='w-7 mt-3'/>
             ...
             className='flex items-center gap-3 sm:gap-5'>
              {toolsData.map((tool,index)=>(
                ...
                className='flex items-center justify-center
                 w-12 sm:w-14 aspect-square border
